...
from .box import Box, search_box
...
class Number (Box):
    ...
    def create(self):
        command = Box.canvas + "obj " + \
            str(self.x) + " " + str(self.y) + " nmb ; "
    ...
    def increment(self):
        ...
        command = Box.canvas + "mouse " + \
            str(self.x+1) + " " + str(self.y+1) + " 1 0 ; "
        command += Box.canvas + "motion " + \
            str(self.x+1) + " " + str(self.y) + " 0 ; "
        command += Box.canvas + "mouseup " + \
            str(self.x+1) + " " + str(self.y) + " 1 0 ; "
    ...
    def decrement(self):
        ...
        command = Box.canvas + "mouse " + \
            str(self.x+1) + " " + str(self.y+1) + " 1 0 ; "
        command += Box.canvas + "motion " + \
            str(self.x+1) + " " + str(self.y+2) + " 0 ; "
        command += Box.canvas + "mouseup " + \
            str(self.x+1) + " " + str(self.y+2) + " 1 0 ; "
        command += Box.canvas + "editmode 1 ; "
        Box.snd.send_pd(command)
